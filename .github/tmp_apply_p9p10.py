...
p9 = '### [ ] P9. Present the 13 GRU inputs as a readable list (observation 5)'
if p9 not in r:
    raise SystemExit('P9 marker missing')
r = r.replace(p9, '### [x] P9. Present the 13 GRU inputs as a readable list (observation 5)', 1)
